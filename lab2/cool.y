...
%{
  ...
  for the location of tokens */
    ...
    */
    ...
    %type <expressions> paras_list
    %type <expressions> paras
    %type <expressions> exprs_list
  ...
  {yyclearin ; $$=NULL;}
    ...
    | expr '.' OBJECTID '(' paras_list ')'
    {
      $$ = dispatch($1,$3,$5);
    }
    | expr '@' TYPEID '.' OBJECTID '(' paras_list ')'
    {
